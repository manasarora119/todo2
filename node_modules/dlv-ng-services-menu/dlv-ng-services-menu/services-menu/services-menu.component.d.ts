...
export declare class ServicesMenuComponent implements OnInit, DoCheck {
    private cookies;
    private authService;
    private menuService;
    private permService;
    ...
    private env;
    private isAllCenter;
    constructor(cookies: CookiesService, authService: AuthService, menuService: MenuService, permService: PermissionService, centerService: CenterService);
    ngOnInit(): void;
    ngDoCheck(): void;
    /**
