...
import { PermissionService, MenuService, CookiesService, CenterService } from '../shared/services';
import { overlayInterface } from './overlayConfiguration.interface';
import 'rxjs/add/operator/catch';
import 'rxjs/add/operator/map';
import 'rxjs/add/operator/toPromise';
import 'rxjs/add/observable/throw';
export declare class ServicesMenuOverlayComponent implements OnInit, DoCheck {
    private menuService;
    ...
    private env;
    constructor(menuService: MenuService, centerService: CenterService, cookies: CookiesService, permission: PermissionService);
    ngOnInit(): void;
    ngDoCheck(): void;
    /**
