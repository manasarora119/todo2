...
export declare class AutoCompleteService {
    ...
    private isApi;
    private centerData;
    constructor(menuService: MenuService, httpService: DlvHttpService, centerService: CenterService);
    /**
     * @name getCenterApi
     ...
     */
    getCenterList(searchQuery: any, type: any): Promise<any>;
    /**
     * @name sortData
     ...
     */
    sortData(data: any, searchString: any): any;
}
