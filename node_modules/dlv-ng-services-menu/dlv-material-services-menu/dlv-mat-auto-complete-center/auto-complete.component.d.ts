...
export declare class DlvMatAutoCompleteComponent implements OnInit, OnChanges {
    ...
    isError: boolean;
    private isData;
    private isPasteCenter;
    inputValue: string;
    customInput: Subject<string>;
    autoFocuse: boolean;
    constructor(autoComplete: AutoCompleteService, centerService: MatCenterService);
    ngOnInit(): void;
    ngOnChanges(): void;
    /**
     * @name pasteEvent
