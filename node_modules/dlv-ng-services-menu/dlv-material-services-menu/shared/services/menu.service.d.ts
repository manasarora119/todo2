export declare class MatMenuService {
    private options;
    private UmsApi;
    private HqApi;
    private FaasApi;
    private linkAddress;
    private ConfigApi;
    private isActiveStaff;
    private performanceLink;
    constructor();
    init(customOptions: any): void;
    /**
     * @name getOptions
    ...
    getOptions(): {
        ...
        showCloseCenterModalBtn: boolean;
        centerStatus: string;
